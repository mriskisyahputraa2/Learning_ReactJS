...
function Coffee() {
    return <>
        {/* <div className="bg-[#00FFCA] min-h-screen">
            <section className="">
                <div className="w-[500px] border-2 border-black mx-auto p-6">
        ...
        <div className="bg-emerald-500 min-h-screen">
            ...
            <div className="flex justify-center mt-4">
                <a href="/drink-list" className="inline-block bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">Cups</a>
            </div>
        </div>
    </>
}
